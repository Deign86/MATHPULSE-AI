...
- [x] gate8: Avatar icon (`/avatar/avatar_icon.png`) replaces user photo in StudentIDCard back and SettingsPage "Dress me up" hover
  EVIDENCE: `StudentIDCard.tsx` line 357 changed to `src="/avatar/avatar_icon.png"` with `object-contain`; `SettingsPage.tsx` line 411 changed to same asset. tsc --noEmit exits 0.
