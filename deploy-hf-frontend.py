"""
Deploy the ZeroGPU Gradio frontend Space for MathPulse AI.

Usage:
    python deploy-hf-frontend.py --token YOUR_HF_TOKEN [--recreate]

This script uploads the ZeroGPU runtime files to:
...
# MathPulse AI ZeroGPU Demo

Grade 11-12 math tutoring demo with on-demand GPU inference.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Deploy MathPulse ZeroGPU frontend Space")
