        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
          <div className="flex-1">
            <div className="flex items-center gap-3">
              ...
              <p className="text-[13px] text-[#64748b] mt-1">                Upload class records and materials to power AI analytics.
              </p>
            </div>          <div className="flex items-center gap-3 shrink-0 self-end sm:self-auto">
            {/* AI Insights Button */}
              <button 
