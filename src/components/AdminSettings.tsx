      ...
      */}
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 md:col-span-9">
            ...
            >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-[#dde3eb] p-6">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-2 bg-[#edf1f7] rounded-lg text-[#5a6578]">
                    <Settings size={20} />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-[#0a1628]">General Settings</h3>
                    <p className="text-sm text-[#5a6578]">Basic system configuration</p>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <select className="w-full px-3 py-2 rounded-xl border border-[#dde3eb] bg-white text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-sky-500/20">
                        <option>English</option>
                        <option>Spanish</option>
                        <option>French</option>
                        <option>German</option>
                      </select>
                      <Globe size={16} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none" />
                    </div>
                  </div>
          ...
          {activeTab !== 'General' && (
            <div className="bg-white rounded-xl shadow-sm border border-[#dde3eb] p-12 text-center">
              <div className="w-16 h-16 bg-[#edf1f7] rounded-full flex items-center justify-center mx-auto mb-4">
                <Settings size={32} className="text-slate-500" />
              </div>
              <h3 className="text-lg font-bold text-[#0a1628] mb-2">{activeTab} Settings</h3>
              <p className="text-[#5a6578] max-w-sm mx-auto">
