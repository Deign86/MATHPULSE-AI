...
const quizQuestionBanks: Record<string, Question[]> = {
  ...
  'gm-4': [
    ...
    { id: 3, type: 'true-false', question: 'The expression 5x G�� 3x simplifies to 2x.', correctAnswer: 'True', explanation: 'Combine like terms: 5x G�� 3x = 2x.', optionExplanations: { 'True': 'Correct! Subtracting coefficients: 5G��3 = 2.', 'False': '5x and 3x are like terms and can be combined.' } },
    { id: 4, type: 'multiple-choice', question: 'What is the slope-intercept form of a linear equation?', options: ['ax + by = c', 'y = mx + b', 'x = my + b', 'y = mx G�� b'], correctAnswer: 'y = mx + b', explanation: 'Slope-intercept form is y = mx + b, where m is slope and b is y-intercept.', optionExplanations: { 'ax + by = c': 'This is standard form.', 'y = mx + b': 'Correct! m = slope, b = y-intercept.', 'x = my + b': 'x and y are reversed.', 'y = mx G�� b': 'The intercept should be + b.' } },
  ...
  'gm-5': [
    ...
    { id: 4, type: 'multiple-choice', question: 'What is the circumference of a circle with radius 7? (Use -� G�� 22/7)', options: ['22', '44', '154', '14'], correctAnswer: '44', explanation: 'C = 2-�r = 2 +� 22/7 +� 7 = 44.', optionExplanations: { '22': 'This is -�r, not 2-�r.', '44': 'Correct! 2 +� 22/7 +� 7 = 44.', '154': 'This is the area (-�r-�), not circumference.', '14': 'This is the diameter (2r).' } },
  ...
  'gm-6': [
    { id: 1, type: 'multiple-choice', question: 'If A = {1,2,3} and B = {2,3,4}, what is A G� B?', options: ['{1,2,3,4}', '{2,3}', '{1,4}', '{1}'], correctAnswer: '{2,3}', explanation: 'A G� B (intersection) contains elements common to both: {2,3}.', optionExplanations: { '{1,2,3,4}': 'That is A G� B (union).', '{2,3}': 'Correct! The intersection has shared elements.', '{1,4}': 'These elements are only in one set each.', '{1}': '1 is only in A, not in both.' } },
    { id: 2, type: 'true-false', question: 'The empty set is a subset of every set.', correctAnswer: 'True', explanation: 'By definition, the empty set G�� is a subset of every set.', optionExplanations: { 'True': 'Correct! G�� G�� A for any set A.', 'False': 'The empty set is indeed a subset of every set by definition.' } },
    { id: 3, type: 'fill-in-blank', question: 'If A = {a, b, c}, the number of elements |A| = ___', correctAnswer: '3', explanation: 'The cardinality |A| counts the elements: a, b, c G�� 3.' },
    { id: 4, type: 'multiple-choice', question: 'What does A G� B represent?', options: ['Elements in both A and B', 'Elements in A or B or both', 'Elements in A but not B', 'Elements not in A'], correctAnswer: 'Elements in A or B or both', explanation: 'Union (G�) combines all elements from both sets.', optionExplanations: { 'Elements in both A and B': 'That describes intersection (G�).', 'Elements in A or B or both': 'Correct! Union includes all elements.', 'Elements in A but not B': 'That describes set difference AG��B.', 'Elements not in A': 'That describes the complement of A.' } },
    { id: 5, type: 'multiple-choice', question: 'Which logical connective represents "and"?', options: ['G�', 'G�', '-�', 'G��'], correctAnswer: 'G�', explanation: 'G� is the logical AND connective.', optionExplanations: { 'G�': 'G� means OR.', 'G�': 'Correct! G� means AND.', '-�': '-� means NOT.', 'G��': 'G�� means IMPLIES.' } }
  ],
  ...
  'pc-1': [
    ...
    { id: 4, type: 'multiple-choice', question: 'What is the range of f(x) = x-�?', options: ['All real numbers', 'x G�� 0', 'y G�� 0', 'y > 0'], correctAnswer: 'y G�� 0', explanation: 'x-� is always non-negative, so the range is y G�� 0.', optionExplanations: { 'All real numbers': 'x-� can never be negative.', 'x G�� 0': 'This describes the domain restriction, not the range.', 'y G�� 0': 'Correct! Squares are always G�� 0.', 'y > 0': 'f(0) = 0, so y = 0 is included.' } },
    { id: 5, type: 'multiple-choice', question: 'If f(x) = 2x and g(x) = x+3, what is (fG��g)(x)?', options: ['2x+3', '2x+6', '2(x+3)', 'Both B and C'], correctAnswer: 'Both B and C', explanation: 'f(g(x)) = f(x+3) = 2(x+3) = 2x+6. Both B and C are equivalent.', optionExplanations: { '2x+3': 'This adds 3 after multiplying. The correct order is f(g(x)) = 2(x+3).', '2x+6': 'Correct form! 2(x+3) = 2x+6.', '2(x+3)': 'Correct form! This equals 2x+6.', 'Both B and C': 'Correct! 2(x+3) and 2x+6 are equivalent.' } }
  ],
  // Basic Calculus
  'bc': [
    ...
    { id: 2, type: 'true-false', question: 'The limit of a function always exists at every point.', correctAnswer: 'False', explanation: 'Limits don\'t always exist, e.g. lim(xG��0) 1/x does not exist.', optionExplanations: { 'True': 'Limits can fail at discontinuities or asymptotes.', 'False': 'Correct! Limits do not always exist.' } },
    { id: 3, type: 'fill-in-blank', question: 'The integral of 2x is ___', correctAnswer: 'x-�', explanation: 'G�2x dx = x-� + C.' },
