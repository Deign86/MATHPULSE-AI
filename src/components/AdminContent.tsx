    ...
    >
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl border border-[#dde3eb] shadow-sm">
          ...
          <p className="text-2xl font-bold text-[#0a1628]">8</p>
        </div>
        <div className="bg-white p-4 rounded-xl border border-[#dde3eb] shadow-sm flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-[#0a1628]">5</p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-xl border border-[#dde3eb] shadow-sm flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-[#0a1628]">2</p>
          </div>
        </div>
        <div className="bg-white p-4 rounded-xl border border-[#dde3eb] shadow-sm flex items-center justify-between">
          <div>
              ...
              <tr key={module.id} className="hover:bg-[#edf1f7] transition-colors group">
                ...
                <td className="p-4 text-right">
                  <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="p-2 hover:bg-[#dde3eb] rounded-lg text-[#5a6578] hover:text-sky-600 transition-colors">
                      <Edit3 size={16} />
                    </button>
                    <button className="p-2 hover:bg-[#dde3eb] rounded-lg text-[#5a6578] hover:text-[#0a1628] transition-colors">
                      <Copy size={16} />
                    </button>
                    <button className="p-2 hover:bg-red-50 rounded-lg text-[#5a6578] hover:text-red-600 transition-colors">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </td>
