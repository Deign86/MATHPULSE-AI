    ...
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none bg-slate-100 border border-slate-200 rounded-lg px-3 py-1.5 pr-8 text-xs font-semibold text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
          >
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        <div className="bg-slate-50 rounded-xl p-3 flex items-center gap-3">
          ...
          <div>
            <p className="text-lg font-bold text-slate-800">{platformAvg}%</p>
            <p className="text-[10px] text-slate-500 uppercase tracking-wider">Platform Average</p>
          </div>
        </div>
        <div className="bg-red-50 rounded-xl p-3 flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-slate-800 truncate">{lowestTopic?.topic}</p>
        ...
        <div className="bg-emerald-50 rounded-xl p-3 flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-slate-800 truncate">{highestTopic?.topic}</p>
          ...
          return (
            <div key={subject.id} className="mb-5 last:mb-0">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] text-slate-400 ml-1">Avg: {subjectAvg}%</span>
              </div>
              ...
              <div className="grid gap-1" style={{ gridTemplateColumns: `repeat(${topics.length}, minmax(0, 1fr))` }}>
                ...
                {topics.map((topic, i) => (
                  <div key={`label-${i}`} className="text-center">
                    <p className="text-[9px] text-slate-400 truncate px-0.5 mb-1" title={topic.name}>
                      {topic.name}
                    </p>
                  </div>
                ))}
