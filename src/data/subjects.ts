    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'gm-3-l2', title: 'Truth Tables', duration: '18 min', completed: false, locked: false },
          { id: 'gm-3-l3', title: 'Logical Equivalence', duration: '16 min', completed: false, locked: false },
          { id: 'gm-3-l4', title: 'Valid Arguments and Fallacies', duration: '22 min', completed: false, locked: false },
        ],
        quizzes: [
