/**
 * achievements.ts — Mobile achievement definitions
 *
 * Mirror of web `src/config/achievements.ts` — 40 achievements across
 * 5 categories (Learning, Battle, Mastery, Exploration, Social).
 *
 * Key difference from web: `icon` is a Lucide display name string
 * rather than a component, since React Native does not use lucide-react.
 */
...
export interface AchievementConfig {
  ...
  title: string;
  description: string;
  /** Lucide icon display name (e.g. "BookOpen") — not a component */
  icon: string;
...
/** Category → achievement counts */
export const CATEGORY_COUNTS: Record<AchievementCategory, number> = {
  learning: 10,
  battle: 10,
  mastery: 8,
  exploration: 7,
